...
# ============= hyper-parameters =============
face_dir = '/data/wangzhe/SematicSeg/GANimation-tf/data/images6/'
au_dir = '/data/wangzhe/SematicSeg/GANimation-tf/data/aus.pkl'
...
with tf.Session() as sess:
    ...
    saver.restore(sess, 'weights/ganimation_epoch21.ckpt')
    ...
    for e in range(1, EPOCHS+1):
        ...
        if e <= 21:
            ...
            lr_now = 1e-6# * (EPOCHS + 1 - e)
        print('===== [Epoch %02d/30](lr: %.5f) =====' % (e, lr_now))

        for i in tqdm(range(len(face) // BATCH_SIZE)):
